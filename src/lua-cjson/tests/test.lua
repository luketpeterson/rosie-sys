...
local cjson_tests = {
    ...
    -- (JAJ) The test below is not a good test, because the keys can appear in
    -- any order when the JSON output is generated.  Lua 5.3 happens to
    -- (always?) put the key "5" first.
